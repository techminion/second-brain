...
5. **Role boundaries live in `agents/`.** Codex, Cursor, and other coding agents act as *implementation* agents within their claimed area. The TPM/architect/reviewer governance role is held by Claude (`agents/architect.md`, `agents/reviewer.md`) — implementation agents do not self-assign it.
